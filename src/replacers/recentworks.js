...
module.exports = async function (user) {
  ...
  const formatJson = (elem) => `<a href="${elem.html_url}">
    <img align="center" height=120 width=340 src="https://github-readme-stats.vercel.app/api/pin/?username=${user}&repo=${encodeURIComponent(
    elem.name,
  )}&theme=chartreuse-dark&border_radius=20"/>
  </a>`;
